"""Утилита для замера производительности конвейера видеоаналитики.

Скрипт выполняет серию прогонов обработки изображения через конвейер
и выводит затраченное время для оценки быстродействия.
"""
