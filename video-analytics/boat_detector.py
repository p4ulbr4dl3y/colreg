...
def detect_boats_bboxes_only(
    ...
    """
    Detect boats and return only bounding boxes (no crops).

    Lighter version when you only need coordinates.

    Args:
        image: Input image as file path or numpy array.
        config: Configuration object.
        confidence_threshold: Override default confidence threshold.
        class_id: Class ID for boat detection.
