"""Узел MQTT для интеграции конвейера видеоаналитики в систему Slew-to-Cue."""
...
class VisionNode:
    ...
    Управляет жизненным циклом конвейера видеоаналитики и обеспечивает
    ...
    def __init__(self):
        """Инициализирует конвейер видеоаналитики и MQTT-клиент с предварительным прогревом моделей."""
